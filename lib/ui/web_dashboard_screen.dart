...
import 'package:fa_bank/bloc/web_dashboard_bloc.dart';
...
class _WebDashboardScreenState extends State<WebDashboardScreen> {
  final WebDashboardBloc _dashboardUserBloc = WebDashboardBloc(WebDashboardInitial());
  ...
  _doRefreshToken() async {
    _dashboardUserBloc.add(WebDashboardEvent());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocProvider<WebDashboardBloc>(
        create: (context) => _dashboardUserBloc,
        child: BlocBuilder<WebDashboardBloc, WebDashboardState>(
